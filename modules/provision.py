    ...
    for arg in args:
        if arg == 'ocp':
            ...
            ocp_macs = [
                ...
                {'name': 'r0b0', 'mac': 'E41D2DFC17D6',
                    'mgmt-mac': 'E41D2DFC17D8'},
                {'name': 'r0b1', 'mac': '7CFE9042E1B4',
                    'mgmt-mac': '7CFE9042E1B6'},
                {'name': 'r0b2', 'mac': 'E41D2DFC7F7A',
                    'mgmt-mac': 'E41D2DFC7F7C'},
                {'name': 'r0b3', 'mac': 'E41D2DFC2A8A',
                ...
                {'name': 'r1a0', 'mac': '7CFE904103EE',
                    'mgmt-mac': '7CFE904103F0'},
                {'name': 'r1a1', 'mac': 'E41D2DFC2B50',
                ...
                # r1b8 is using a 2x10 nic
                # original macs are 7CFE9041045A/7CFE9041045C
                {'name': 'r1b8', 'mac': '248A07907064',
                    'mgmt-mac': '248A07907066'},
                {'name': 'r1b9', 'mac': '7CFE9041A516',
                    'mgmt-mac': '7CFE9041A518'},
                {'name': 'r1c0', 'mac': 'E41D2DFC4164',
                    'mgmt-mac': 'E41D2DFC4166'},
